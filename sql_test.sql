-- Volume, Denial Rate, and Initial Denial Rate by Line of Business, Acuity, and Stay Type
...
SELECT
    ...
    SUM(initial_denied_ind)                                                     AS initial_denied_pmes,
    SAFE_DIVIDE(SUM(initial_denied_ind), COUNT(DISTINCT pme_reference_no))      AS initial_denial_rate,
